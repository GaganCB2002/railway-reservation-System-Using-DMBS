	...
	<div class="wrap">
		...
		<div class="span12 well">
			...
			<div id="myCarousel" class="carousel slide" style="width:600px; float:left;margin-bottom:3px;">		
				...
				<div class="item"><img src="images/13.jpeg" style="width:600px;height:350px;"/></div>
				<div class="item"><img src="images/14.jpeg" style="width:600px;height:350px;"/> </div>
				<div class="item"><img src="images/15.jpeg" style="width:600px;height:350px;"/></div>
				<div class="active item"><img src="images/16.jpeg" style="width:600px;height:350px;"/> </div>
				<div class="item"><img src="images/13.jpeg" style="width:600px;height:350px;"/></div>
				<div class="item"><img src="images/17.jpeg" style="width:600px;height:350px;"/> </div>
...
<footer >
		<div style="width:100%;">
			...
			<p class="text-right text-info">  &copy;@ DBMS MINI PROJECT AIT COLLGE </p>	
			</div>
			<div style="float:right;">
			<p class="text-right text-info">	Desinged By : GAGAN C B</p>
			</div>
		</div>
		</footer>	</div>
